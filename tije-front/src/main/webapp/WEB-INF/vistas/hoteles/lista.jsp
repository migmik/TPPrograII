        ...
        <c:choose>
            ...
            <c:otherwise>
                <table>
                    ...
                    <thead>
                        <tr><th scope="col">Nombre</th><th scope="col">Ciudad</th>
                            <th scope="col">Capacidad total</th><th scope="col">Consulta</th></tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${hoteles}" var="hotel">
                            <tr>
                                <td><c:out value="${hotel.nombre}"/></td>
                                <td><c:out value="${hotel.ciudad}"/></td>
                                <td><c:out value="${hotel.capacidadTotal}"/></td>
                                <td><a href="<c:url value='/hoteles/${hotel.codigo}'/>">Ver detalle y disponibilidad</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
