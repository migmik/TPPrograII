...
public class ControladorAdministracion {
    ...
    public ControladorAdministracion(Agencia agencia) { this.agencia = agencia; }
    ...
    public boolean modificarHotel(Usuario u,int c,String n,String d,String ciudad,String tel,int plazas){
        if(!puede(u,Permiso.ADMINISTRAR_HOTELES)||plazas<0)return false; Hotel h=agencia.buscarHotelPorCodigo(c);if(h==null)return false;
