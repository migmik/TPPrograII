...
public record GuardarHotelSolicitud(
                ...
                @NotBlank(message = "La ciudad es obligatoria") @Size(max = 255, message = "La ciudad no puede superar 255 caracteres") String ciudad,
                ...
                @NotNull(message = "La capacidad total es obligatoria") @PositiveOrZero(message = "La capacidad total no puede ser negativa") Integer capacidadTotal) {
}
