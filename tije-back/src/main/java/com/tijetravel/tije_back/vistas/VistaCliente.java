    ...
    private void mostrarVuelos() {
        ...
        for (Vuelo vuelo : agencia.getVuelos()) {
            ...
            System.out.println("Turista disponibles: "
                    + controladorReservas.plazasDisponiblesVuelo(vuelo,
                            com.tijetravel.tije_back.modelos.ClaseVuelo.TURISTA)
                    + " de " + vuelo.getPlazasTurista());
            /*
             * System.out.println("Primera disponibles: "
             * + controladorReservas.plazasDisponiblesVuelo(vuelo,
             * com.tijetravel.tije_back.modelos
             * System.out.println("Primera disponibles: "
             * + controladorReservas.plazasDisponiblesVuelo(vuelo,
             * tijetravel.modelos.ClaseVuelo.PRIMERA)
